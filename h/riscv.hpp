...
public:
    ...
    //supervisor trap
    static void supervisorTrapSystem();
    static void supervisorTrapTime();
    static void supervisorTrapConsole();
    static void unknownTrap();

    static void ivtable();

    //static void handleSupervisorTrapSystem();

private:

    //rukovaoci prekidima
    static void handleSupervisorTrapSystem();
    static void handleSupervisorTrapTime();
    static void handleSupervisorTrapConsole();
    static void handleUnknownTrap();
